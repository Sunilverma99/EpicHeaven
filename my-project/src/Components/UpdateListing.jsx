...
export default function UpdateListing() {
  const {currentuserListing}=useSelector((state)=>state.user)
  ...
  const [formData ,setFormData ]=useState({
     imageUrls:currentuserListing.imageUrls,
     name:currentuserListing.name,
     description:currentuserListing.description,
     address:currentuserListing.address,
     sale:currentuserListing.sale,
     rent:currentuserListing.rent,
     parking:currentuserListing.parking,
     furnished:currentuserListing.furnished,
     offer:currentUser.offer,
     beds:currentuserListing.beds,
     bedrooms:currentuserListing.bedrooms,
     bathrooms:currentuserListing.bathrooms,
     regularPrice:currentuserListing.regularPrice,
     discountedPrice:currentuserListing.discountedPrice,
     userRef:currentuserListing.userRef
  });
...
try {
  setLoading(true);
    const response = await fetch(`http://localhost:3000/api/updateListing/${currentuserListing._id}`, config);
